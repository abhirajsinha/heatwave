...
description: Heatwave REVIEWER role. Dispatch for PLAN_REVIEW, FULL_REVIEW, TARGETED_REVIEW, FINAL_REVIEW, the LIGHT combined pass (via `.heatwave/prompts/final-reviewer.md`, R-125), EXPRESS_CHECK (via `.heatwave/prompts/express-checker.md` — fresh context), and Escalation Reports. Must never review an artifact this context authored.
---
