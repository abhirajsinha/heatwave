...
Delete `.heatwave/`, `heatwave.config.yaml`, and the Heatwave block from your instruction file. Runs are plain files — archive them if you want the audit history.
